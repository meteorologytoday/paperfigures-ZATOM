...
ax.annotate("\$ A_3 = \\left( \\frac{1 + \\mu + \\nu \\gamma \\xi}{2 \\mu} , \\gamma - \\frac{\\left(1 + \\mu + \\nu \\gamma \\xi\\right)^2}{4 \\mu}\\right) \$", xy=(y_low, dydt_low),  xycoords="data",
...
ax.set_ylabel("\$\\mathrm{d} \\delta S / \\mathrm{d} t \$")
