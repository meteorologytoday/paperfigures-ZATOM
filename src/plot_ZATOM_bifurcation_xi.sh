...
python3 src/plot_bifur_analysis.py --folder \
   ./data/continuation_data_fixed_xi_072522/batch_std20/output_redo_balanced_tanh/CM_xi00000050_pos/lb$res  \
   ./data/continuation_data_fixed_xi_072522/batch_std20/output_redo_balanced_tanh/CM_xi00000000_pos/lb$res  \
