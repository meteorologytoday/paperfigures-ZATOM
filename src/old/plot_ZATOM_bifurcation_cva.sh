...
python3 src/plot_scans_and_snapshots.py --folder \
   ...
   ./data/continuation_data/batch_cva50/output_redo_tanh/CM_cva_delta00000005_neg/lb8  \
   ...
   ./data/continuation_data/batch_cva50/output_redo_tanh/CM_cva_delta00000020_pos/lb8  \
    ...
    --F-rng -0.01 0.8 --psi-rng 5 10 --metric max --output-bifur "figures/bifurcation_cva.png" \
     --marks 0.342 8.595 \
             0.342 6.441 
