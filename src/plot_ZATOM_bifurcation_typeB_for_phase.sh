...
python3 src/plot_scans_and_snapshots.py --folder \
   ...
   ./data/continuation_data_0522/batch_std20/output_redo_balanced_tanh/CM_xi-0000075_pos/lb$res  \
   ./data/continuation_data_0522/batch_std20/output_redo_balanced_tanh/CM_xi-0000050_pos/lb$res  \
   ./data/continuation_data_0522/batch_std20/output_redo_balanced_tanh/CM_xi-0000025_pos/lb$res  \
   ./data/continuation_data_0522/batch_std20/output_redo_balanced_tanh/CM_xi00000000_pos/lb$res  \
   ./data/continuation_data_0522/batch_std20/output_redo_balanced_tanh/CM_xi00000025_pos/lb$res  \
